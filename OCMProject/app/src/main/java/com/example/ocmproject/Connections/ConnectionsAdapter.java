...
public class ConnectionsAdapter extends RecyclerView.Adapter<ConnectionsAdapter.ViewHolder> {
     ...
     */
    public ConnectionsAdapter(Context context, List<User> data){ //change all User s with your model class's name
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType){
        View view = inflater.inflate(R.layout.connections_layout, parent, false);// set your custom layout here
