package com.example.ocmproject.MyInterests;
...
public class MyInterestsAdapter extends RecyclerView.Adapter<MyInterestsAdapter.ViewHolder> {
     ...
     */
    public MyInterestsAdapter(Context context, List<String> data){ //change all User s with your model class's name
    ...
    public void onBindViewHolder(ViewHolder holder, int position){
        String other = data.get(position);
        holder.myTextView.setText(other);
