...
public class OtherProfileFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = (View) inflater.inflate(R.layout.fragment_other_profile, container, false);
        ...
        // INTERESTS PRINTER
        mDatabase.child("NewUser").child(userId).child("Interests").addValueEventListener(new ValueEventListener() {
            @Override
